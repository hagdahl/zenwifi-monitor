...
| ADR-004 | 2026-07-26 | Approved | Tests, dry-run, and the current scheduled task must never request a router restart. Production activation requires a separate deployment decision and a separate launcher change. | Independent safety boundary requested by the project owner. |
